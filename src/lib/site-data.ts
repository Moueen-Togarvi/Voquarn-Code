...
export const services: Service[] = [
  ...
  },
  {
    ...
    description:
      "Complete management software for schools, colleges, hospitals, clinics, farms, and any business — PKR 2,000/month, and a working demo within 4 hours.",
    deliverables: ["Custom CRM", "Role-based dashboards", "Monthly or one-time plans", "Live demo in 4 hours"],
    subServices: [
      {
        id: "school-management",
        name: "School Management System",
        description: "One system for students, teachers, attendance, exams, and fee collection — no more registers.",
        pricePkr: 2000,
        priceUsd: 7,
        features: ["Student & teacher records", "Attendance and exam results", "Fee challans and receipts", "Parent SMS/WhatsApp alerts", "Working demo in 4 hours"],
      },
      {
        id: "college-management",
        name: "College Management System",
        description: "Built for colleges and universities: admissions, semesters, faculty timetables, and fee tracking.",
        pricePkr: 2000,
        priceUsd: 7,
        features: ["Admissions and enrollment", "Semester & course management", "Fee and scholarship tracking", "Faculty and timetable planner", "Working demo in 4 hours"],
      },
      {
        id: "hospital-management",
        name: "Hospital Management System",
        description: "Runs the whole hospital: patient files, doctor duties, wards, pharmacy, lab, and billing.",
        pricePkr: 2000,
        priceUsd: 7,
        features: ["Patient records and history", "Doctor and ward scheduling", "Pharmacy and lab billing", "Admission and discharge flow", "Working demo in 4 hours"],
      },
      {
        id: "clinic-management",
        name: "Clinic Management System",
        description: "Light and fast system for a single clinic — appointments, visit history, and printed prescriptions.",
        pricePkr: 2000,
        priceUsd: 7,
        features: ["Appointment booking", "Patient visit history", "Prescription printing", "Daily income reports", "Working demo in 4 hours"],
      },
      {
        id: "farm-management",
        name: "Farm Management System",
        description: "Track crops, livestock, feed, stock, labour wages, and see exactly where the profit goes.",
        pricePkr: 2000,
        priceUsd: 7,
        features: ["Crop and livestock records", "Feed, stock and expense logs", "Worker attendance & wages", "Yield and profit reports", "Working demo in 4 hours"],
      },
      {
        id: "business-crm",
        name: "Business CRM & Custom System",
        description: "A CRM shaped around your own business — leads, customers, invoices, staff roles, and reports.",
        pricePkr: 2000,
        priceUsd: 7,
        features: ["Leads and deal pipeline", "Customer profiles and notes", "Invoices and payment tracking", "Staff roles and permissions", "Working demo in 4 hours"],
      },
    ],
  },
];
