      ...
      <div className="mx-auto max-w-7xl rounded-[2.5rem] bg-[var(--panel)] border border-[var(--border)] p-8 md:p-12 lg:p-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-5 flex flex-col space-y-7">
            ...
            <p className="text-[13px] text-[var(--muted)] max-w-sm leading-relaxed font-semibold">
            ...
            <div className="w-full max-w-sm h-48 rounded-2xl overflow-hidden border border-[var(--border)] relative shadow-sm">
              <iframe
          ...
          <div className="lg:col-span-3 flex flex-col space-y-7 pt-2">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                aria-label="LinkedIn"
              >
                <svg className="w-4 h-4 text-[var(--muted)] group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-16 pt-8 border-t border-[var(--border)]">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-[12px] text-[var(--muted)] order-2 md:order-1">
              &copy; {new Date().getFullYear()} Voquarn Code. All rights reserved.
            </p>

            <div className="flex items-center gap-1 bg-[var(--surface)] border border-[var(--border)] rounded-full px-1.5 py-1 order-1 md:order-2">
              <Link
                href="/terms"
                className="px-4 py-1.5 rounded-full text-[11px] font-medium text-[var(--muted)] hover:text-[var(--foreground)] hover:bg-[var(--panel)] hover:shadow-sm transition-all duration-200"
              >
                Terms of Service
              </Link>
