  ...
  return (
    <section className="relative w-full py-10 md:py-12 bg-[var(--background)] text-[var(--foreground)] border-b border-[var(--section-border)] overflow-hidden select-none">
      <div className="max-w-7xl mx-auto px-6 mb-6">
        ...
        <h2 className="text-2xl md:text-3xl font-black uppercase tracking-tight font-display text-[var(--foreground)]">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex flex-col flex-1 min-h-0">
                  ...
                  <h3 className="text-base md:text-lg font-bold font-display tracking-tight text-[var(--foreground)] mb-2.5 flex-shrink-0">
                    {activeTab.title}
                  </h3>
