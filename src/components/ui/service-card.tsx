      ...
      <div className="relative z-10 flex flex-col h-full justify-between">
        ...
        <div className="mt-6 flex-1 flex flex-col justify-center">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[11px] text-[var(--muted)]">• {service.title}</span>
          </div>

          <h3 className="mt-1.5 text-[22px] font-bold text-[var(--foreground)] tracking-tight leading-[1.2] line-clamp-2">
            {service.title}
          </h3>

          <p className="mt-2 text-[13px] font-medium leading-6 text-[var(--muted)] line-clamp-2">
            {service.description}
          </p>
