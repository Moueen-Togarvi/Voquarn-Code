  ...
  return (
    <section className="page-section mt-24 lg:mt-32 pt-40 lg:pt-56 max-w-4xl mx-auto">
      ...
      <div className="mt-16 prose prose-neutral max-w-none space-y-8 pb-32 text-black [&_h2]:!text-black [&_li]:!text-black [&_p]:!text-black">
        <div>
          <h2 className="mb-4 text-xl font-semibold text-black">1. Acceptance of Terms</h2>
          <p>
        ...
        <div>
          <h2 className="mb-4 text-xl font-semibold text-black">2. Services Description</h2>
          <p>
        ...
        <div>
          <h2 className="mb-4 text-xl font-semibold text-black">3. Client Responsibilities</h2>
          <p>
        ...
        <div>
          <h2 className="mb-4 text-xl font-semibold text-black">4. Payment Terms</h2>
          <p>
        ...
        <div>
          <h2 className="mb-4 text-xl font-semibold text-black">5. Intellectual Property</h2>
          <p>
        ...
        <div>
          <h2 className="mb-4 text-xl font-semibold text-black">6. Limitation of Liability</h2>
          <p>
        ...
        <div>
          <h2 className="mb-4 text-xl font-semibold text-black">7. Contact Information</h2>
          <p>
