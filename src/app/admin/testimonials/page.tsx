...
import { Loader2, Plus, MessageSquare, Pencil, X, Star } from "lucide-react";
import { AdminPageHeader } from "@/components/admin/admin-page-header";
import { DeleteDialog } from "@/components/admin/delete-dialog";

type Testimonial = { id?: number; name: string; company: string; review: string; stars: number; order: number };

const empty = { name: "", company: "", review: "", stars: 5, order: 0 };
    ...
    <div>
      ...
      items.length === 0 ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((t) => (
            <div key={t.id} className="rounded-2xl border border-[var(--border)] bg-[var(--panel)] p-5">
