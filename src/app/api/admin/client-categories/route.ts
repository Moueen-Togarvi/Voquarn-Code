...
import { AdminValidationError, parseClientCategory } from "@/lib/admin-validation";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const [item] = await db.insert(clientCategories).values(parseClientCategory(body)).returning();
